...
<!-- Badges -->
<div style="margin: 25px 0;">
  <a href="https://pypi.org/project/parlant/"><img alt="PyPI - Versão" src="https://img.shields.io/pypi/v/parlant?style=for-the-badge&logo=pypi&logoColor=white&color=3776ab" /></a>
  <img alt="PyPI - Versão Python" src="https://img.shields.io/pypi/pyversions/parlant?style=for-the-badge&logo=python&logoColor=white&color=3776ab" />
  <a href="https://opensource.org/licenses/Apache-2.0"><img alt="Licença Apache 2" src="https://img.shields.io/badge/license-Apache%202.0-blue.svg?style=for-the-badge&logo=apache&logoColor=white" /></a>
</div>

<div style="margin: 15px 0;">
  <img alt="Atividade de commits" src="https://img.shields.io/github/commit-activity/w/emcie-co/parlant?label=commits&style=for-the-badge&logo=github&logoColor=white&color=181717" />
  <img alt="PyPI - Downloads" src="https://img.shields.io/pypi/dm/parlant?style=for-the-badge&logo=pypi&logoColor=white&color=3776ab" />
  <a href="https://discord.gg/duxWqxKk6J"><img alt="Discord" src="https://img.shields.io/discord/1312378700993663007?style=for-the-badge&logo=discord&logoColor=white&label=discord&color=5865f2" /></a>
</div>
...
<div align="center" style="margin: 40px 0;">
  ...
  <a href="https://www.youtube.com/watch?v=_39ERIb0100" target="_blank">
    <img alt="Introdução ao Daneel" src="yt-preview.png" width="600" style="border-radius: 12px; box-shadow: 0 8px 32px rgba(0,0,0,0.1); transition: transform 0.3s ease;" />
  </a>
...
graph TD
    ...
    Engine -->|Carregar Terminologia| GlossaryStore[📖 Glossário]
    Engine -->|Combinar Diretrizes| GuidelineMatcher[🎯 Matcher]
    Engine -->|Inferir e Chamar| ToolCaller[🛠️ Ferramentas]
    Engine -->|Personalizar Mensagem| MessageComposer[✍️ Compositor]
    Engine -->|Logs em Tempo Real| WebSocketLogger[📊 Logger]
    Engine -->|Gerenciar Tags| TagStore[🏷️ Tags]
    Engine -->|Relacionamentos| RelationshipStore[🔗 Relações]
    Engine -->|Insights| ToolInsights[💡 Insights]

    WebSocketLogger -->|Stream| SandboxUI[🖥️ Interface Sandbox]
    SandboxUI -->|Visualizar| LogViewer[👁️ Log Viewer]
    TagStore -->|Organizar| Tags[📋 Sistema de Tags]
    RelationshipStore -->|Conectar| Relationships[🔄 Relacionamentos]

    style Engine fill:#667eea,stroke:#333,stroke-width:3px,color:#fff
    style WebSocketLogger fill:#11998e,stroke:#333,stroke-width:2px,color:#fff
    style SandboxUI fill:#f093fb,stroke:#333,stroke-width:2px,color:#fff
```
...
<div align="center" style="margin: 40px 0;">
  <a href="https://star-history.com/#emcie-co/parlant&Date" target="_blank">
    <img alt="Gráfico de Histórico de Estrelas" src="https://api.star-history.com/svg?repos=emcie-co/parlant&type=Date" style="border-radius: 12px; box-shadow: 0 8px 32px rgba(0,0,0,0.1);" />
  </a>
...
<div align="center" style="margin: 50px 0; padding: 40px 20px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 20px; color: white;">
  ...
  <img alt="Daneel Logo" src="logo.png" width="80" height="80" style="border-radius: 15px; margin-bottom: 20px; opacity: 0.9;" />
