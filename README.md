...
```mermaid
graph TD
    A[🔍 Avalia a situação atual] --> B[✅ Verifica as diretrizes relevantes]
    B --> C[🔧 Reúne informações através de ferramentas]
    C --> D[🔄 Reavalia continuamente sua abordagem]
    D --> E[🎯 Adapta-se mantendo conformidade]
    E --> F[💬 Gera resposta final]
```
