			...
			{event && (
				<div className={twMerge('flex items-center justify-between w-full pe-[12px]')}>
					...
					<div className='flex items-center gap-[12px] mb-[1px]'>
						<div
							className='group bg-[#0053B3] [box-shadow:0px_2px_4px_0px_#00403029,0px_1px_5.5px_0px_#0053B329] hover:bg-[#004494] flex  h-[38px] rounded-[5px] ms-[4px] items-center gap-[7px] py-[13px] px-[10px]'
							role='button'
